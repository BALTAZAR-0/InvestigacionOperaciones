"""Point plotting module for SymPy

The module implements a data series called PlotSeries which is used by
...
from sympy.plotting.experimental_lambdify import experimental_lambdify, vectorized_lambdify
...
class PlotSeries(BaseSeries):
    ...
    def __init__(self, expr, var_start_end_x, var_start_end_y,
                 depth,
            line_color):
        super(PlotSeries, self).__init__()
